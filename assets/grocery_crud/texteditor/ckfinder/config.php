...
function CheckAuthentication()
{
	...
	return true;	// <-- so this is exactly what we shouldn't do...!!! however, it's only used in htaccess protected area now...
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'Bitman';
$config['LicenseKey'] = '8JAG-1YQ7-G7D3-BLCT-2B9J-VJL7-H7EF';
...
//dit is nodig om de verwijzing relatief goed te krijgen. Dit kan mis gaan als het in een submap lokaal zit
$baseUrl = '/assets/uploads/';

// dit gebruikt de scriptname (connector.php roept blijkbaar de config.php op) om vervolgens te verwijzen naar de juiste map op de server. Als scriptname niet juist is (kan volgens DAAN), dan moet je het serverpad hard invullen.

$baseDir = resolveUrl($baseUrl);

//$baseDir = str_replace('assets/grocery_crud/texteditor/ckfinder/core/connector/php/connector.php', 'assets/uploads/', $_SERVER['SCRIPT_FILENAME']);
