<?php
	...
	$this->set_js($this->default_theme_path.'/bootstrap/js/flexigrid-edit.js');
?>
...
<div id='main-table-box'>
	...
	<div class='form-div'>
		...
		<div id='report-success' class='report-div success'></div>
			...
			<input type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn"/>
<?php 	if(!$this->unset_back_to_list) { ?>
			<input type='button' value='<?php echo $this->l('form_update_and_go_back'); ?>' id="save-and-go-back-button" class="btn"/>
			<input type='button' value='<?php echo $this->l('form_cancel'); ?>' onclick='javascript: return goToList()' class="btn" />
<?php 	} ?>
